                ...
                <List>
                    {
                        navItem.map(({text,icon})=>{
                            if(!icon){
                                return(
                                    <Typography key={text} sx={{m:"1.25rem 0 .3rem 3rem"}}>
                                        {text}
                                    </Typography>
                                )
                            }
                    ...
                    <Box position='absolute' bottom='1rem'>
                        ...
                        <FlexBetween textTransform='none' gap='1rem' m='1rem 2rem 0 3rem'>
                            ...
                            />
                                <Box textAlign='left' sx={{cursor:'pointer'}} >
                                ...
                                <SettingsOutlined sx={{color:theme.palette.secondary[300],fontSize:'25px',cursor:'pointer'}} />
